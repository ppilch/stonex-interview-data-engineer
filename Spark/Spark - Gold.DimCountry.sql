...
-- MAGIC %md
-- MAGIC Create a table containing countries with ISO-3166 codes
...
DROP TABLE IF EXISTS Gold.DimCountry;

CREATE TABLE Gold.DimCountry
(	CountryKey BIGINT GENERATED ALWAYS AS IDENTITY (START WITH 1 INCREMENT BY 1) 
